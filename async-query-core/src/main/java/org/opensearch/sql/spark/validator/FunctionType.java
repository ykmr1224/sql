...
public enum FunctionType {
  ...
  private static final Map<FunctionType, Set<String>> FUNCTION_TYPE_TO_FUNCTION_NAMES_MAP =
      ImmutableMap.<FunctionType, Set<String>>builder()
          ...
          .put(UNCATEGORIZED,
              Set.of(
                  "aggregate", "array_size", "array_sort", "cardinality", "crc32", "exists",
                  "filter", "forall", "hash", "ilike", "in", "like", "map_filter",
                  "map_zip_with", "md5", "mod", "named_struct", "parse_url", "raise_error",
                  "reduce", "reverse", "sha", "sha1", "sha2", "size", "struct",
                  "transform", "transform_keys", "transform_values", "url_decode",
                  "url_encode", "xpath", "xpath_boolean", "xpath_double", "xpath_float",
