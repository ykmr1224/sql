...
public class CalcitePPLAggregationIT extends PPLIntegTestCase {
  ...
  public void testAggregateWithExtraParametersThrowsException() throws IOException {
    ...
    verifyExplainException(
        ...
        "Aggregation function MIN expects field type and additional arguments {[ANY]},"
            + " but got [LONG,INTEGER]");
    verifyExplainException(
        source(TEST_INDEX_BANK, "stats max(balance, age)"),
        "Aggregation function MAX expects field type and additional arguments {[ANY]},"
            + " but got [LONG,INTEGER]");
  }

  @Test
  public void testVarianceStddevWithExtraParametersThrowsException() throws IOException {
    verifyExplainException(
  ...
  @Test
  public void testPercentileWithInvalidParametersThrowsException() throws IOException {
    verifyExplainException(
  ...
  @Test
  public void testEarliestLatestWithTooManyParametersThrowsException() throws IOException {
    verifyExplainException(
